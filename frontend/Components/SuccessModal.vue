      ...
      <div v-if="show" class="fixed inset-0 z-[9999] flex items-center justify-center bg-gradient-to-br from-black/80 via-black/70 to-green-950/20 backdrop-blur-xl overflow-hidden" @click="handleClose">
        ...
        >
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            <button
              @click="handleClose"
              class="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold py-3 px-4 rounded-xl transition-all transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-green-600/50 flex items-center justify-center gap-2"
            >
            ...
            <button
              @click="handleClose"
              class="flex-1 bg-gray-800/50 hover:bg-gray-700/50 text-gray-200 font-bold py-3 px-4 rounded-xl transition-all transform hover:scale-105 active:scale-95 border border-gray-700 flex items-center justify-center gap-2"
            >
